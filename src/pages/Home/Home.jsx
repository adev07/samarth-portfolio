  ...
  return (
    <div className="bg-[#0D0D0D] min-h-[100vh]">
      ...
      <div className="pb-[440px]">
        <div className="flex text-[#fff] items-center justify-center gap-[300px] custom-fonts">
          <div className="text-center">
            <div className="text-[20px] font-semibold">Packet Fanatic</div>
            <div className="text-[14px] font-normal leading-normal">
              Jan 2021 - Jun 2021
            </div>
          </div>
          <div className="text-center">
            <div className="text-[20px] font-semibold">Samsung R&D</div>
            <div className="text-[14px] font-normal leading-normal">
              June 2021 - June 2022
            </div>
          </div>
          ...
          <div className="text-center">
            <div className="text-[20px] font-semibold">Codeclock</div>
            <div className="text-[14px] font-normal leading-normal">
              Aug 2023 - Present
            </div>
          </div>
        ...
        <div className="flex items-center justify-center mt-2">
          ...
          <div className="h-px bg-white w-[435px]"></div>
          <div className="w-2 h-2 bg-white rounded-full"></div>
          <div className="h-px bg-white w-[435px]"></div>
          <div className="w-2 h-2 bg-white rounded-full"></div>
          <div className="h-px bg-white w-[435px]"></div>
